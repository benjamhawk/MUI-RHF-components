...
var RadioButtonGroup = function (_a) {
    ...
    var inputProps = __rest(useController(__assign({ name: name, control: control, defaultValue: defaultValue !== null && defaultValue !== void 0 ? defaultValue : options[0].value }, useControllerProps)).field, []);
    return (React.createElement(FormControl, __assign({}, formControlProps),
        ...
        React.createElement(RadioGroup, __assign({}, inputProps, radioGroupProps), options.map(function (option) { return (React.createElement(FormControlLabel, __assign({ key: option.value, value: option.value, label: option.label, control: React.createElement(Radio, __assign({}, radioProps)) }, (formControlLabelProps || {})))); }))));
};
